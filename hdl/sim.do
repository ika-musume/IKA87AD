...
add wave -noupdate -expand -group {ALU MULDIV} -radix hexadecimal /IKA87AD_tb/u_dut/alu_muldiv_r2_temp
add wave -noupdate -radix hexadecimal /IKA87AD_tb/u_dut/reg_TEMP
add wave -noupdate -expand -group ALU /IKA87AD_tb/u_dut/sreg_RDBUS
add wave -noupdate -expand -group ALU -radix unsigned /IKA87AD_tb/u_dut/mc_type
add wave -noupdate -expand -group ALU -radix unsigned /IKA87AD_tb/u_dut/mc_sa_dst
add wave -noupdate -expand -group ALU -radix unsigned /IKA87AD_tb/u_dut/mc_sb
add wave -noupdate -expand -group ALU -radix unsigned /IKA87AD_tb/u_dut/mc_sc_dst
add wave -noupdate -expand -group ALU -radix unsigned /IKA87AD_tb/u_dut/mc_sd
add wave -noupdate -expand -group ALU -radix unsigned /IKA87AD_tb/u_dut/mc_regfile_acc_mode
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/regfile_addr
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/reg_RDBUS
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_pa
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_pb
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_adder_op0
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_adder_op1
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_adder_out
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_output
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_ma_output
add wave -noupdate -expand -group ALU -radix hexadecimal /IKA87AD_tb/u_dut/alu_div_out
...
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/div3_tick
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/ci_sampler
add wave -noupdate -group EVENT -radix unsigned /IKA87AD_tb/u_dut/ci_nedet
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/ci_state
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/sr_wr_addr
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/sreg_ETMM
add wave -noupdate -group EVENT -radix unsigned /IKA87AD_tb/u_dut/sreg_ETM0
add wave -noupdate -group EVENT -radix unsigned /IKA87AD_tb/u_dut/sreg_ETM1
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/event_cntr_cnt
add wave -noupdate -group EVENT -radix unsigned /IKA87AD_tb/u_dut/event_cntr
add wave -noupdate -group EVENT -radix unsigned /IKA87AD_tb/u_dut/event_cntr_next
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/cntr0_match
add wave -noupdate -group EVENT /IKA87AD_tb/u_dut/cntr1_match
add wave -noupdate -group EXCEPTIONS /IKA87AD_tb/u_dut/eflag
add wave -noupdate -group EXCEPTIONS /IKA87AD_tb/u_dut/fs_OV
add wave -noupdate -group EXCEPTIONS /IKA87AD_tb/u_dut/fs_ANx
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {10620 ps} 0}
